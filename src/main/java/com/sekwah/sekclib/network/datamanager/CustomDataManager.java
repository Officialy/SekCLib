 ...
 * {@link net.minecraftforge.fml.network.PacketDistributor}.
 *
...
public abstract class CustomDataManager<T> {
     ...
     * @param playerEntity
     */
    public void playerStopTracking(ServerPlayerEntity playerEntity, CustomDataTracker tracker) {
     ...
     */
    public void playerStartTracking(ServerPlayerEntity playerEntity, CustomDataTracker tracker) {
